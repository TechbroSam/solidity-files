...
contract EXPERIMENT is ERC20, Ownable {
   ...
   address public _owner;
    ...
    uint256 public maxTokensPerWallet = CIRCULATING_SUPPLY / 200; // 0.5% of the circulating supply
...
modifier onlyEOAs() {
    ...
    IUniswapV2Router02 _uniswapRouter = IUniswapV2Router02(0x327Df1E6de05895d2ab08513aaDD9313Fe505d86); //BaseV2 0x4cf76043B3f97ba06917cBd90F9e3A2AAC1B306e
    uniswapRouter = _uniswapRouter;
    uniswapPair = IUniswapV2Factory(_uniswapRouter.factory())
    .createPair(address(this), _uniswapRouter.WETH()); 
    uniswapRouterAddress = 0x327Df1E6de05895d2ab08513aaDD9313Fe505d86;    //0x7a250d5630B4cF539739dF2C5dAcb4c659F2488D
