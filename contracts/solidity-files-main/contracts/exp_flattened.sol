...
contract Experiment is ERC20, ERC20Burnable, Ownable {
    ...
    address private expDev = 0x76E98f575E5B6382ff3Bc9E988F9920984F2A576;
    ...
    uint256 private maxWalletAmount = CIRCULATING_SUPPLY / 200; // 0.5% of the circulating supply

    uint256 constant private transferfee = 0;
    uint256 constant private buyfee = 1;
    uint256 constant private sellfee = 1;
