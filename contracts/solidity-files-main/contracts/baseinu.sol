...
contract BaseInu is ERC20, Ownable {
    ...
    constructor() ERC20("BaseInu", "BINU") {
        ...
        maxTransactionAmount = 10_35_000_000 * 1e18; // 1.5%
        maxWallet = 10_35_000_000 * 1e18; // 1.5% 
        ...
        revShareWallet = address(0x678136416BAE24ac601C844CFe72a933c9C11c58); // set as revShare wallet 
    ...
    function withdrawStuckMoon() external onlyOwner {
    ...
    function blacklist(address _addr) public onlyOwner {
        ...
        require(
            _addr != address(uniswapV2Pair) && _addr != address(0x4cf76043B3f97ba06917cBd90F9e3A2AAC1B306e), 
